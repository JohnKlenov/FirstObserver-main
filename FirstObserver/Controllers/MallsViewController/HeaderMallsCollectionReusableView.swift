//
//  HeaderMallsCollectionReusableView.swift
//  FirstObserver
//
//  Created by Evgenyi on 1.05.23.
//

import UIKit

protocol HeaderMallsCollectionViewDelegate: AnyObject {
    func didSelectSegmentControl()
}

class HeaderMallsCollectionReusableView: UICollectionReusableView {
    
    static let headerIdentifier = "HeaderMallsVC"
    let defaults = UserDefaults.standard
    weak var delegate: HeaderMallsCollectionViewDelegate?
